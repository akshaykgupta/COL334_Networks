...
\hspace*{-1.4cm}
{\centering{
{\includegraphics[scale=0.8]{objectchart.png}
}
}
}
\vspace*{-0.6cm}
...
\hspace*{-1.4cm}
{\centering{
{\includegraphics[scale=0.8]{objectchart1.png}
}
}
}
\vspace*{-0.6cm}
...
~\\\\
{\centering{
{\includegraphics[scale=0.9]{classchart1.png}
}
}
...
~
{\centering{
{\includegraphics[scale=0.4]{classchart.png}
}
}
\vspace*{-0.6cm}
...
\hspace*{-3cm}
{\centering{
{\includegraphics[scale=0.8]{active_time.png}
}
}
...
\hspace*{-2cm}
{\centering{
{\includegraphics[scale=0.75]{active_time1.png}
}
}
...
\vspace*{-3cm}
{\centering{
{\includegraphics[scale=0.75]{goodput.png}
}
}
...
\hspace*{-2cm}
{\centering{
{\includegraphics[scale=0.8]{goodput1.png}
}
}
